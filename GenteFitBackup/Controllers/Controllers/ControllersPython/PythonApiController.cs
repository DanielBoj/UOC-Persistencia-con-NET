...
namespace GenteFitOdoo.Controllers.Controllers.ControllersPython
{
    public class PythonApiController : ControllerBase
    {
        ...
        // Obtenemos todos los empleados de la BBDD de Odoo
        public async Task<List<EmpleadoOdoo>> GetAllEmpleados() => await _api.GetAllEmpleados();

        // Obtenemos todos los pedidos de la BBDD de Odoo
        public async Task<List<Pedido>> GetAllPedidos() => await _api.GetAllPedidos();
    }
}
