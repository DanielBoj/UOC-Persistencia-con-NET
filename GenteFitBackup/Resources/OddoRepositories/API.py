...
from read_odoo_controller import getClientes, getEmpleados, getPedidos, getProductos, getProveedores
...
# Obtenemos los empleados mediante nuestro controlador


@app.route('/empleados')
def get_empleados():
    # Llamamos a nuestro controlador
    empleados_list = getEmpleados()

    return empleados_list

# Obtenemos la lista de los pedidos mediante nuestro controlador
@app.route('/pedidos')
def get_pedidos():
    # Llamamos a nuestro controlador
    pedidos_list = getPedidos()
