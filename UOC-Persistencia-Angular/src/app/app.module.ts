...
import { EmpleadosodooComponent } from './modules/odoo/empleadosodoo/empleadosodoo.component';
import { ClientesodooComponent } from './modules/odoo/clientesodoo/clientesodoo.component';
import { ProveedoresodooComponent } from './modules/odoo/proveedoresodoo/proveedoresodoo.component';
import { ProductosodooComponent } from './modules/odoo/productosodoo/productosodoo.component';
import { PedidosodooComponent } from './modules/odoo/pedidosodoo/pedidosodoo.component';
...
@NgModule({
    declarations: [
        ...
        OdooComponent,
        EmpleadosodooComponent,
        ClientesodooComponent,
        ProveedoresodooComponent,
        ProductosodooComponent,
        PedidosodooComponent,
    ],
    imports: [
